          ...
          <div className="mt-7 bg-black  rounded-xl shadow-lg  shadown-md ">
            <div className="p-4 sm:p-7">
              <div className="text-center z-50">
                <h1 className="z-50 text-2xl font-bold text-gray-800 ">
                  Forgot password?
                </h1>
              </div>
                    ...
                    <div className="top-10 relative mx-10 md:mx-5">
                      <div className="mt-6 z-50">
                        <div className="mt-1 z-50 flex flex-col rounded-md shadow-sm">
                          <label
                            htmlFor="username"
                            className="z-50 mb-1 text-sm font-medium leading-5 text-white/80"
                          >
                            Mobile Number
                          </label>
                          <div
                      ...
                      <div className="z-50">
                        <span className="w-full flex flex-col my-3 rounded-md shadow-sm z-50">
                          <Button
                            ...
                            className="w-full dark:text-white bg-[#55637B] hover:bg-[#5d6d88] dark:hover:bg-[#00264D]"
                          >
                            Reset Password
                          </Button>
                        </span>
