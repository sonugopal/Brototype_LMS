...
const VerifyOtpFunction = (state: string[], phoneNumber: string, firstName: string, lastName: string, email: string, qualification: string, password: string, successToast: any, customToast: any, router: any, setDisableButton: any) => {
