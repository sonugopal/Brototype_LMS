...
const userInputValidation = (firstName: string, lastName: string, phoneNumber: string, email: string, qualification: string, password: string, confirmPassword: string, failed: any, setDisableButton: Dispatch<SetStateAction<boolean>>, setLoading: Dispatch<SetStateAction<boolean>>) => {
